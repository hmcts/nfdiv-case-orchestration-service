...
public class CaseControllerTest {
    ...
    public void whenSubmitDraft_thenReturnCaseResponse() throws Exception {
        ...
        when(caseService.submitCase(caseData, AUTH_TOKEN)).thenReturn(serviceReturnData);
    ...
    public void givenErrors_whenSubmittingDraft_thenReturnBadRequest() throws Exception {
        ...
        when(caseService.submitCase(caseData, AUTH_TOKEN)).thenReturn(invalidResponse);
