package uk.gov.hmcts.reform.divorce.orchestration.controller.bulk.scan;
...
import static uk.gov.hmcts.reform.divorce.orchestration.controller.bulk.scan.S2SAuthTokens.ALLOWED_SERVICE_TOKEN;
import static uk.gov.hmcts.reform.divorce.orchestration.controller.bulk.scan.S2SAuthTokens.I_AM_NOT_ALLOWED_SERVICE_TOKEN;
            ...
            .andExpect(content().string(
                allOf(
                    ...
                    hasJsonPath("$.case_creation_details", allOf(
                        hasJsonPath("case_type_id", is("NO_FAULT_DIVORCE")),
